...
var _jokes = require("./jokes"); //E2015
...
// });
//*With Jquery
(0, _jokes.jokes).getOne().then((joke)=>{
    (0, _jqueryDefault.default)("#joke").text(joke);
});
const copy = "Copyright 2018";
(0, _jqueryDefault.default)("#copy").text(copy);

},{"./jokes":"lQktk","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","fs":"jhUEF"}],"lQktk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const jokes = {
    getOne: function() {
        return new Promise((resolve, reject)=>{
            (0, _axiosDefault.default).get("http://api.icndb.com/jokes/random").then((res)=>{
...
},{}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequiree738")
